...
// of all other references
locals {
  instance_security_groups             = ["${var.security_group_ids}"]
  security_groups_elb_masters          = ["${var.security_group_ids}"]
  security_groups_elb_masters_internal = ["${var.security_group_ids}"]
  security_groups_elb_public_agents    = ["${var.security_group_ids}"]
}
